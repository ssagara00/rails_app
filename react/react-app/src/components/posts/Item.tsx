...
export function Item({ post, setPosts }: PostItemProps) {
    ...
    <li>
      ...
      <div className="card w-96 bg-base-100 shadow-xl">
            ...
            <div>
              ...
              <div className="button-actions">
                <button
                  ...
                  onClick={() => updatestart(post.id || 0, post.title, post.contents)}
                >
                  更新
                </button>
                ...
                <button className="btn btn-secondary" onClick={() => handleDeletePost(post.id || 0)}>
                  削除
                </button>
              </div>
            </div>
        ...
        <div className="card-body items-center text-center">
          ...
          {post.contents.length > 9 ? <p>{post.contents.substring(0, 6)}...</p> : <p>{post.contents}</p>}

          <div className="card-actions">
            <button className="btn btn-secondary" onClick={() => detailstart(post.id || 0)}>
              詳細
            </button>
          ...
          {isSignedIn && (
            <div className="card-actions">
              <button className="btn btn-secondary" onClick={() => replystart(post.id || 0, post.title)}>
                返信
              </button>
